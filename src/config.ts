...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    deployments: require('./zomb-finance/deployments/deployments.testing.json'),
    externalTokens: {
      WZSP: ['0xf1277d1ed8ad466beddf92ef448a132661956621', 18],
      ...
      'USDT-ZSP-LP': ['0xE7e3461C2C03c18301F66Abc9dA1F385f45047bA', 18],
      'ZOMB-ZSP-LP': ['0xE9Fd98DEa3F4Bdab7A4b1F03117F3F44955aA8c5', 18],
      'ZSHARE-ZSP-LP': ['0x20bc90bB41228cb9ab412036F80CE4Ef0cAf1BD5', 18],
    },
  ...
  production: {
    ...
    externalTokens: {
      WZSP: ['0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  ZombFtmLPTShareRewardPool: {
    name: 'Earn ZSHARE by ZOMB-ZSP LP',
    poolId: 0,
    sectionInUI: 2,
    contract: 'ZombFtmLPTShareRewardPool',
    depositTokenName: 'ZOMB-ZSP-LP',
  ...
  ZshareFtmLPTShareRewardPool: {
    name: 'Earn ZSHARE by ZSHARE-ZSP LP',
    poolId: 1,
    sectionInUI: 2,
    contract: 'ZshareFtmLPTShareRewardPool',
