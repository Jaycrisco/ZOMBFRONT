...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    externalTokens: {
      ZOMB: ['0x2C26617034C840C9412CD67aE0Fc68A6755D00BF', 18],
      ...
      'USDT-ZOMB-LP': ['0xE7e3461C2C03c18301F66Abc9dA1F385f45047bA', 18],
      'ZOMB-ZSP-LP': ['0xE9Fd98DEa3F4Bdab7A4b1F03117F3F44955aA8c5', 18],
      'ZSHARE-ZOMB-LP': ['0x20bc90bB41228cb9ab412036F80CE4Ef0cAf1BD5', 18],
    },
  ...
  production: {
    ...
    externalTokens: {
      ...
      'USDT-ZOMB-LP': ['0x2b4C76d0dc16BE1C31D4C1DC53bF9B45987Fc75c', 18],
      'ZOMB-ZSP-LP': ['0xE9Fd98DEa3F4Bdab7A4b1F03117F3F44955aA8c5', 18],
      'ZSHARE-ZOMB-LP': ['0x4733bc45eF91cF7CcEcaeeDb794727075fB209F2', 18],
    },
    baseLaunchDate: new Date('2021-06-02 13:00:00Z'),
    bondLaunchesAt: new Date('2020-12-03T15:00:00Z'),
    masonryLaunchesAt: new Date('2020-12-11T00:00:00Z'),
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  TombFtmLPTombRewardPool: {
    name: 'Earn ZOMB by ZOMB-ZOMB LP',
    poolId: 0,
    sectionInUI: 1,
  ...
  TombFtmLPTShareRewardPool: {
    name: 'Earn ZSHARE by ZOMB-ZOMB LP',
    poolId: 0,
    sectionInUI: 2,
  ...
  TshareFtmLPTShareRewardPool: {
    name: 'Earn ZSHARE by ZSHARE-ZOMB LP',
    poolId: 1,
    sectionInUI: 2,
    contract: 'TshareFtmLPTShareRewardPool',
    depositTokenName: 'ZSHARE-ZOMB-LP',
    earnTokenName: 'ZSHARE',
    finished: false,
    sort: 7,
    closedForStaking: false,
